...
![img](https://pic3.zhimg.com/80/v2-7ce999561b15a78da9ac78765d06fe5e_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-86d4a9b4b3a26af9548e37c0b4598ec0_720w.png)
...
![img](https://pic1.zhimg.com/80/v2-74b43859d669589d953fa59eb7c57778_720w.png)
...
![img](https://pic2.zhimg.com/80/v2-3fcf19069d014dc969f120b38f7f01a1_720w.png)
...
![img](https://pic3.zhimg.com/80/v2-76a05aa3154a064d727cb8ef53190382_720w.png)
...
- __new__(cls,[...)
  ...
  __new__ 是对象实例化时第一个调用的方法，它只取下 cls 参数，并把其他参数传给 __init__ 。 __new__ 很少使用，但是也有它适合的场景，尤其是当类继承自一个像元组或者字符串这样不经常改变的类型的时候。我不打算深入讨论 __new__ ，因为它并不是很有用， [Python文档](https://link.zhihu.com/?target=http%3A//www.python.org/download/releases/2.2/descrintro/%23__new__) 中 有详细的说明。
...
请参考 [28.8. abc - Abstract Base Classes - Python 2.7.13 documentation](https://link.zhihu.com/?target=http%3A//docs.python.org/2/library/abc.html).
...
![img](https://pic1.zhimg.com/80/v2-e27863611d4b5450c1849aa23217b8ec_720w.png)
